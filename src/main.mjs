...
////////////////////////////////////////////////////////////////////////////////
var polygon = (window.polygon = new L.Polygon(
...
var polyline = (window.polyline = new L.Polyline(
  L.GeoJSON.coordsToLatLngs([
...
var rectangle = (window.rectangle = new L.Rectangle(
  L.latLngBounds([
...
var polygonWithHole = (window.polygonWithHole = new L.Polygon(
  [
    L.GeoJSON.coordsToLatLngs([
...
var multiPolygon = (window.multiPolygon = new L.Polygon(
  [
    L.GeoJSON.coordsToLatLngs([
...
var multiPolyline = (window.multiPolyline = new L.Polyline(
  [
    L.GeoJSON.coordsToLatLngs([
